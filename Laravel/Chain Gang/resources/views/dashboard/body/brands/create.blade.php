        ...
        <div class="col-md-12">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h4 class="c-grey-900 mB-20">Merk Aanmaken</h4>
                  ...
                  <div class="row">   
                    <div class="btn-back">
                        <a href="{{ route ('brands') }}"><span class="btn btn-primary tables-function-button">Terug</span></a>
                    </div>
                    <div class="btn-add-newsletter-layout">
                        <button class="btn btn-primary tables-function-button">Merk aanmaken</button>
                    </div>                
                </div>    
            </div>
        </div>
