                    ...
                    <div class=" masonry-itemcol-md-12">
                        <form class="container" id="needs-validation" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom05">Telefoonnummer</label> <input type="text" class="form-control" id="validationCustom05" placeholder="+31638304835" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="validationCustom05">Postcode</label> <input type="text" class="form-control" id="validationCustom05" placeholder="2232 AA" required>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="validationCustom03">Huidige wachtwoord</label> <input type="password" class="form-control" id="validationCustom03" placeholder="password" required password>
                                    <div class="invalid-feedback">Please provide a valid adres.</div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="validationCustom03">Nieuwe wachtwoord</label> <input type="password" class="form-control" id="validationCustom03" placeholder="password" required password>
                                    <div class="invalid-feedback">Please provide a valid adres.</div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="validationCustom03">Nieuwe wachtwoord bevesteging</label> <input type="password" class="form-control" id="validationCustom03" placeholder="password" password required>
                                    <div class="invalid-feedback">Please provide a valid adres.</div>
                                </div>
                            </div>
                            <div class="row">
