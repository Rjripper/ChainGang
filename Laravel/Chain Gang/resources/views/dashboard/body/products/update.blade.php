                            ...
                            <div class="masonry-item col-md-4">
                                <div class="row">
                                    <div class="col-md-10 md-3">
                                        ...
                                        <input type="text" class="form-control" id="product_name" name="product_name" value="{{ old('product_name', $product->product_name) }}" placeholder="Product naam" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                            ...
                            <div class="masonry-item col-md-8">
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea  class="form-control" name="description" id="description" cols="30" rows="10" placeholder="Beschrijving" required>{{$product->description}}</textarea>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea  class="form-control" name="specifications" id="specifications" cols="30" rows="6" placeholder="Specificaties" required>{{$product->specifications}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-6">
                                <div class="text-right">
                                    <button class="btn btn-primary tables-function-button" onclick="updateProduct({{$product->id}});" type="button">Product wijzigen</button>
                                </div>
                            </div>
                        </div>                        
                    </div>
...
function updateProduct(product_id) {
    ...
    $.ajax({
        ...
        success: function(){
            Swal.fire({
                type: 'success',
                title: 'Wijziging Product',
                html: "U heeft de product aangepast.",
                timer: 3000
            });
        },
        error: function(response) {
            ...
            Swal.fire({
                type: 'error',
                title: 'Wijziging Product!',
                html: "Er traden foutmeldingen op tijdens het wijzigen van de product.<br><br>" + myErrors,
