...
@section('body')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">         
                                        ...
                                        {{-- Data-id = Order_id --}}
                                        <i class="ti-trash tables-icons" data-id="{{$category->id}}" onclick="deleteCategory(this);"></i> 
                                    </div>
                                </td>
                            </tr>
                            @endforeach
    ...
    function deleteCategory(node)
    {
        ...
        let category_id = node.getAttribute('data-id'); //Pak de Product-Id
        $.ajax({
            url: '/admin/category/delete/' + category_id , //Je url
            dataType: 'json',
            cache: false,
            contentType: false,
            processData: false,
