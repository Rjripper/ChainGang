<div class="sidebar">
    <div class="sidebar-inner">
        ...
        <ul class="sidebar-menu scrollable pos-r">
            <li class="nav-item mT-30"><a class="sidebar-link" href="{{ route ('dashboard') }}"><span class="icon-holder"><i class="c-blue-500 ti-home"></i> </span><span class="title">Dashboard</span></a></li>
            ...
            <li class="nav-item"><a class="sidebar-link" href="{{ route ('products') }}">
                <span class="icon-holder"><i class="c-deep-orange-500 ti-archive"></i> </span><span class="title">Producten</span></a>
                <ul class="sidebar-menu" style="padding: 0 40px;height: unset;">
                    <li class="nav-item"><a class="sidebar-link" href="{{ route ('brands') }}"><span class="icon-holder"><i class="c-deep-orange-500 ti-angle-right"></i> </span><span class="title">Merken</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="{{ route ('types') }}"><span class="icon-holder"><i class="c-deep-orange-500 ti-angle-right"></i> </span><span class="title">Types</span></a></li>
                    <li class="nav-item"><a class="sidebar-link" href="{{ route ('categories') }}"><span class="icon-holder"><i class="c-deep-orange-500 ti-angle-right"></i> </span><span class="title">Categoriën</span></a></li>
